...
const { eylanding } = require('./src/utils/.11ty/eylanding');
const { color_tags } = require('./src/utils/.11ty/color-tags');
const { markdown_tables } = require('./src/utils/.11ty/markdown-tables');
const { collapsibles } = require('./src/utils/.11ty/collapsibles');
const MathJax = require("./src/utils/.11ty/MathJax");
