...
| relative cost ratio of $c_1$ "Before"<br>simulated by sim v3.0<br>("Total Negative") | $c_1$ "Before" wrongly purchased after the reset instead of before the reset<br>("False Positive") | $c_1$ "Before" purchased in-line with the result from sim v3.0<br>("True Negative") |
