...
The wait for one of the several CTs ready for review to be tested and approved continues but at some point Gilles has to awake from hibernation, right? Right? continues crying
...
This is the first installment of the rankings and news which is only here and was created only for the website (discounting the 2022 review which is at least not the usual thing)!
