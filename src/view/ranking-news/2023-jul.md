...
- There might be some changes incoming though, aimed at improving the appeal of custom theories over the theory automator; I'll don't want to go further as its not like aynthing is done yet but there were discussions about it with Gilles involved.
...
??. leaderboard name (Discord name) - ee?????:
