...
> They have all their messages on the server from a single day about 29 months ago, which is an achievement in itself I guess^^ Actually cannot finde them anymore, maybe because of the Discord name update? Or maybe because Discord sometimes doesn't want to actually search.
>
