...
2. Weierstraß Sine Product by xelaroc: this was the first added custom theory already included in 1.4.21. I won't recount everything as you can look to the rankings and news yourself for some history. Just the most important knowledge condensed:
...
3. Sequential Limits by Ellipsis: this was the second custom theory, added a week after 1.4.21 was released.
...
4. Euler's Formula by Snaeky (idea), peanut (programming) and XLII (balancing): released at the same time as the next official custom theory and the first one to be developed by a team. As it was the faster one, it was mostly chosen to be played first and it is also listed third.
...
5. Convergents to \\(\sqrt{2}\\) by Solarion: released at the same time as Euler's Formula.
