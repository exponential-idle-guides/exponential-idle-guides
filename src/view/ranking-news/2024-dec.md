...
Nope, you did not mishear (or misread?), Gilles has blessed us once again with a new CT, this time, only 1: Reimann Zeta function! This new CT is topping T8 in terms of graph chaos, and milestone swapping (with the most active, and most pointless MS I've even seen). 
This new CT has only been out for a bit, but the leaderboards are aready on fire, with taus nearing quadruple digits! These new CTs are *fast*
...
And of course, to simulated this new theory comes a brand new shiny theory sim! This improvement on XLIIs was no small task, amazing job to [Instert CT creators here]. I'm no coder, but even I can see the work and dedication that must have gone into making it. For all the community, we thank you!
...
November 2024 Top 20 on the leaderboard, their \\(f(t)\\) at the time the list was compiled and their Discord connection (Discord names in brackets are not their nicknames!), data collected December 1st:
...
> Just brely scraping into 20 top last month, he rises to 18th, and down to 26. Those are all the updates so my work here is done
...
> Well, he managed to do it, and would be #4, well now #5 in the andoid lb. Congrats on reaching top 10! (and representing iOS players).
> 
...
not on lb (Propfeds) - ee:

> As said before we have been blassed with a new CT, and this is the person we have to thank!
> 
> This CT juggernaut is seemingly an expert at making these, creating RZ (almost) all on his own (okay who am I kidding). He did the research, coding, and balancing required on the journey of CT creation and has given us all a wonderful new custom theory for us all to enjoy!
> 
> If anyone deserves an honourable mention, it's him. Keep up the amazing work, and I hope to play another one of your CTs soon! (Keep your eyes peeled for Lemma's Garden full release maybe sometime)
