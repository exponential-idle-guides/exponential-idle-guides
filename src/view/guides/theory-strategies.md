...
While the "X" is only directly in the \\(c_2\\) buying condition, because the \\(c_1\\) buying condition is based on the cost of \\(c_2\\), the "X" also indirectly affects how much \\(c_1\\) is bought. <br /> <br />
