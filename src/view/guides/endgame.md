...
Make sure to use the <a href="status-prefix: 'Open Other Resources'" onmouseover="window.status=''" onclick="openSidebar(['ResourceSidebar','GuideSidebar','HeaderSidebar'],'SidebarHeaders')">calculators and simulators</a> for optimal graduation, student, star, and theory options.
