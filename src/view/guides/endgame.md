...
Make sure to use the <a href="javascript:void(0);" onclick="openSidebar(['ResourceSidebar','GuideSidebar','HeaderSidebar'],'SidebarHeaders')">calculators and simulators</a> for optimal graduation, student, star, and theory options.
