...
window.onload = ()=>{
  ...
  if (globals.Mobile) {
    ...
    globals.qstyle.setProperty('--sidebar-list-1-left', '-1rem');
    globals.qstyle.setProperty('--sidebar-list-1-top', '0rem');
    globals.qstyle.setProperty('--sidebar-list-2-left', '-1.1rem');
    globals.qstyle.setProperty('--sidebar-list-2-top', '-0.5rem');
